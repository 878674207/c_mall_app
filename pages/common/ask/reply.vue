<template>
    <view class="askContainer">
        ...
        <view class="askTital">
            ...
            <span class="askTitalTwo">回答问题</span>
            <!-- <span>我的回答</span>  -->
            <image class="imgse" :src="`${imgBasePath}/static/images/icons/icon-myq&a.png`"
                style="width: 28px; height: 28px;" @click="MyAnswer" />
        </view>
        ...
        <view class="askContent">
            <view class="contentItem">
                <u--textarea v-model="text" border="none" placeholder="请您回答"></u--textarea>
            ...
            <view class="btnBox">
                <button @click="saveMyQuestion">发布</button>
            </view>
        </view>
    </view>
</template>
...
import { saveReply } from '@/api/system/question.js'
export default {
    data() {
        return {
            keyword: '',
